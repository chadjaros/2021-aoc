...
class N implements Node {
    ...
    get edges(): Edge[] {
        ...
        const nextDirs = Point.adjacentDirs().filter((d) => !d.equals(reverseDir) && (this.dirCt < 3 || !d.equals(this.dir)));
...
aoc((infile) => {
    ...
    const result = dijkstra(startNode, graph, (n) => n.point.equals(target));
